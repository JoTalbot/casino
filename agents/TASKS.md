...
**Весь бэклог смен #1 и #2 закрыт (T-001 … T-023).** Задачи ниже
поставлены сменой #2 как продолжение; ни одна не начата.

| ID | Задача | Приоритет | Статус | Агент | Обновлено |
|----|--------|-----------|--------|-------|-----------|
| T-024 | Экран ответственной игры в клиенте: лимиты, самоисключение, reality check | P2 | todo | — | 2026-08-17 |
| T-025 | Правила игры (ToS) и политика конфиденциальности + возрастной гейт 18+ | P2 | todo | — | 2026-08-17 |
| T-026 | Боевой сервер на Fastify по ADR-005: PostgreSQL, идемпотентность, JWT | P1 | in-progress | arena-2026-08-19-A | 2026-08-19 |
| T-027 | Календарные окна счётчиков RG: считать из ledger_entries, а не из памяти | P2 | todo | — | 2026-08-17 |
| T-028 | Мониторинг RTP по ADR-007: интервал от фактического n, алерт от 100 тыс. раундов | P3 | todo | — | 2026-08-17 |
| T-029 | Вторая игра на том же движке: проверка, что математика переиспользуется | P3 | todo | — | 2026-08-17 |
