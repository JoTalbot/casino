...
**ID не переиспользуются.** Следующий свободный ID: **T-038**

---

## Активные и запланированные

Новые задачи смены J:

| ID | Задача | Приоритет | Статус | Агент | Обновлено |
|----|--------|-----------|--------|-------|-----------|
| T-034 | История раундов в клиенте: список, карточка, пагинация | P1 | in-progress | arena-2026-08-19-J | 2026-08-19 |
| T-035 | Верификатор в модалке клиента: проверка раунда без перехода на verifier/ | P2 | todo | — | 2026-08-19 |
| T-036 | Графики RTP и активности в админке (Chart.js) | P2 | todo | — | 2026-08-19 |
| T-037 | Тесты для админки и мониторинга (admin + rtp) | P2 | todo | — | 2026-08-19 |

Ранее закрытые (T-001…T-033 — done):
