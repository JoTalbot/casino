...
**ID не переиспользуются.** Следующий свободный ID: **T-049**

---

## Активные и запланированные

**Весь бэклог T-001…T-048 закрыт.** Новых активных задач нет.
...
- **Q-006** открыт по итогам T-016 и помечен 🔴: безопасность варианта A держится на отсутствии покупок фишек. До ответа владельца монетизация не реализуется, см. `research/07-SOCIAL-CASINO-LEGAL.md`.
